...
import { baseUrl, getVariantAttribute, variantArrayFormat, currencyCode, capitalizeLetter, getSizeName, variant_thumb_img_path1 } from "@/Http/helper";
          ...
          <div className="colo_list_outer22">
            ...
            {attributes[key].map((item) => (
              (key === "Color" || key === "Colour") && item.withImage == "Yes" ? (
                ...
                >
                  <Image width={50} height={60} src={`${baseUrl}${variant_thumb_img_path1}${item.image_1}`} alt="Variant"></Image>
